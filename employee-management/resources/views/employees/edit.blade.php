            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="basic_salary" value="{{ $employee->basic_salary }}" class="form-control" placeholder="Basic Salary">
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-12">
                    <div class="form-group">
                        <strong>Date Joined:</strong>
                        <input type="date" name="date_joined" value="{{ $employee->date_joined }}" class="form-control" placeholder="Date Joined">
                    </div>
                </div>
